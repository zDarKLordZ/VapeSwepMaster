...
JuicyVapeJuices = {
	...
	{name = "Weed", color = Color(0,255,12,255)},
	{name = "Skittles", color = nil}, --nil means rainbow
	{name = "Doritos", color = Color(255,114,0,255)},
	{name = "Tobacco", color = Color(67,11,11,255)},
	{name = "Blue Ball", color = Color(0,221,255,255)},
	{name = "Peach", color = Color(255,123,0,255)},
	{name = "Kiwi", color = Color(33,255,0,255)},
}
